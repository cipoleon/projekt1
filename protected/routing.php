...
switch ($_GET['P']) {
	...
	case 'list_project': IsUserLoggedIn() ? require_once PROTECTED_DIR.'project/list.php' : header('Location: index.php'); break;

	case 'list_material': IsUserLoggedIn() ? require_once PROTECTED_DIR.'material/list.php' : header('Location: index.php'); break;
